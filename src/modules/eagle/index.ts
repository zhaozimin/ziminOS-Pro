 ...
 *          core/types 的 ZiminosContext，依赖本模块 platform/client/transfer/render
 * [OUTPUT]: 对外提供 EagleSettingActions 与 registerEagleBridge，将运行时行为及设置页所需操作收成一个边界
...
export function registerEagleBridge(ctx: ZiminosContext): EagleSettingActions {
