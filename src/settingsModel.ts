...
export const TABS: readonly SettingsTab[] = [
    ...
    },
    {
        ...
        module: '左侧边栏 v1',
        status: '运行中 · 四十二条命令配 Pikaicons 图标，默认摆出七条',
    },
];
...
export const TEXTS = {
    ...
    autoUpdatedDesc:
        '改完带 YAML 的笔记，自动记下最后一次修改的时间。'
        + '正开着的那一篇等你切走或关掉才写进去——在你眼皮底下写盘会被 Obsidian 当成外部修改，视口就跳走了；'
        + '直接退出也不丢，下次打开 Obsidian 时补上。记下的是你改完的那一刻，不是写进去的那一刻。'
        + '没有 YAML 的笔记一个字都不动。',
